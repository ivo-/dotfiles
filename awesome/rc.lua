...
for s = 1, screen.count() do
   ...
   tags[s] = awful.tag({ "editor", "www", "term", "im", "media", "other" },
                       s,
                       { layouts[1], layouts[1], layouts[2], layouts[1], layouts[3], layouts[1] })
end
-- }}}
...
vicious.register(batwidget, vicious.widgets.bat, "<span color='#D0F5A9'>$1 $2% $3</span>", 61, "BAT0" )
-- }}}
...
globalkeys = awful.util.table.join(
   ...
   -- Media keys
   awful.key({}, "XF86AudioMute", function () awful.util.spawn_with_shell("volume toggle") end),
   awful.key({}, "XF86AudioRaiseVolume", function () awful.util.spawn_with_shell("volume up") end),
   awful.key({}, "XF86AudioLowerVolume", function () awful.util.spawn_with_shell("volume down") end),

   awful.key({}, "XF86KbdBrightnessUp", function () awful.util.spawn_with_shell("backlight-up") end),
...
-- TODO: Move tags to 1,2,3 and 9,0
